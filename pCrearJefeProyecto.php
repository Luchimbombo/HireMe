...
<body>		
  ...
  <div class="container-fluid">
	...
	<div class="col-sm-6 col-sm-offset-3 myform-cont">
		<h1>Registrar Jefe de proyecto</h1>
			<div class="myform-bottom">
			<form action="crearJefeProyecto.php" method="POST">
				Rut: <input type="text" name="rutJefe" class="form-control" required="required">
				Nombre: <input type="text" name="nombreJefe" class="form-control" required="required">
				Apellido: <input type="text" name="apellidoJefe" class="form-control" required="required">
				Especialidad: <input type="text" name="especialidadJefe" class="form-control" required="required"> <br>
