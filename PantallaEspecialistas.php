...
<body>		
	...
	<div class="sidebar">
		...
		<ul>
			<li class="dropdown">
				<a href="#"  role="button"> Mis Solicitudes </a>
	...
	<br>
		...
		<br ><br >
			<table class='table table-bordered'>
				<tr>
					<th>Id</th><th>jefe</th><th>especialista</th><th>status</th><th><span class="glyphicon glyphicon-user"></span></th>
				</tr>			
<?php
			...
			if ($resultado = $mysqli->query($consulta)) 
			{
				...
				{					
					...
					echo"<td>";						
				    echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-nombre='" .$fila[1] ."' data-edad='" .$fila[2] ."' data-direccion='" .$fila[3] ."' class='btn btn-warning'></span>Ver Datos</a> ";			
					echo "<a class='btn btn-danger'>Mandar solicitud</a>";	
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
...
<?php
			...
			$consulta= "SELECT * FROM especialista1";
			if ($resultado = $mysqli->query($consulta)) 
			{
				while ($fila = $resultado->fetch_row()) 
				{					
				    ...
				    echo "<a data-toggle='modal' data-target='#editUsu' data-id='" .$fila[0] ."' data-nombre='" .$fila[1] ."' data-edad='" .$fila[2] ."' data-direccion='" .$fila[3] ."' class='btn btn-warning'></span>Ver Mis Datos</a> ";	
					echo "</td>";
					echo "</tr>";
				}
				$resultado->close();
