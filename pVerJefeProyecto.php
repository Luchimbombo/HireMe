...
<body>		
  ...
  <div class="container-fluid">
	...
	<?php
		...
		$sql_consultar= "SELECT * FROM jefeproyecto ORDER BY apellidoJefeP ASC";
		$resultados=$conex->query($sql_consultar);
	?>
		<h1>Ver Jefe de proyectos</h1>
			...
			<tbody>
				...
				?>
					<tr>
						...
						<td><?php echo $fila['nombreJefeP'];?></td>
						<td><?php echo $fila['apellidoJefeP'];?></td>
						<td><?php echo $fila['especialidadJefeP'];?></td>
					</tr>
				<?php
					}
				?>
